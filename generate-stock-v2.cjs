...
const wb = XLSX.readFile('C:\\Users\\DELL\\Desktop\\BM Apple Iphone Store Stock Management V2.xlsx');
...
let sql = `-- ============================================\n`;
sql += `-- BM Apple Iphone Store Stock V2 - Full Import\n`;
sql += `-- Source: BM Apple Iphone Store Stock Management V2.xlsx\n`;
...
fs.writeFileSync('stock-v2-import.sql', sql);
console.log(`Generated stock-v2-import.sql with ${data.length} items`);
